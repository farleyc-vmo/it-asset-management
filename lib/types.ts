// ============ ENUMS ============
export type AssetStatus = 'active' | 'maintenance' | 'retired' | 'deployed' | 'in_stock'
export type AssignmentStatus = 'pending' | 'assigned' | 'returned' | 'cancelled'
export type AssignmentType = 'permanent' | 'temporary' | 'project'
export type Priority = 'low' | 'medium' | 'high' | 'urgent'
export type EmployeeStatus = 'active' | 'inactive' | 'on_leave' | 'terminated'
export type EntityType = 'asset' | 'employee' | 'department' | 'warehouse' | 'assignment' | 'category'
